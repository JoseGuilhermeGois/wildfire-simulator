...
from config.environment import create_fake_environment
...
class FireSimulator:
    ...
    def run(self, landscape_filename: str,
            fuel_models_filename: str,
            ignition_points_filename: str,
            iterations_filename: str
            ):
...
if __name__ == '__main__':
    ...
    defaults_fuel = DefaultsFuel() #tkinter
    ...
    fire_simulator.run(
        ...
        ignition_points_filename="resources/ignitions.txt",
        iterations_filename="resources/timestep.txt"
    )
