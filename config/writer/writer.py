...
def create_file(list_of_ignitions: list[CombustibleElement], ignition_counter, elapsed_time):
    with open("C:\\Users\\guigo\\Software\\IMfireProject\\output\\fire.out", "w") as outfile:
        outfile.write("V 0.1\n")
        outfile.write(str(round(elapsed_time, 1)) + "    Present time from first ignition in seconds\n")
        ...
        for element in list_of_ignitions[:-2]:
            outfile.write("{}  {}  {}  {}  {}  {}  {}  {}  {}  {}\n".format(
                element.latitude,
                element.longitude,
                element.location.real_latitude,
                element.location.real_longitude,
                "{:E}".format((element.ros * 0.00508 if element.ros is not None else 0)),
                ...
                round(element.time_of_ignition, 2)
            ))
